...
export default function AILoadingState() {
  ...
  // `sequenceIndex` is kept in range by a modulo below; the fallback is for
  // the type checker, which cannot see that.
  const currentSequence = TASK_SEQUENCES[sequenceIndex] ?? TASK_SEQUENCES[0];
