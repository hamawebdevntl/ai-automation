    ...
    >
      ...
      <div className="relative z-10 mt-6">
        ...
        >
          ...
          institutional-grade security. <span className="text-foreground/50">Start trading in minutes.</span>
        </motion.p>
      ...
      >
        <div className="overflow-hidden rounded-xl">
          <img src="https://i.postimg.cc/ZnKjd7Y7/db.webp" alt="CryptoTrade Dashboard" className="h-auto w-full" />
        </div>
