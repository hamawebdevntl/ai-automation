...
// The template referenced `animate-ui/components/animate/tooltip`, a styled
// wrapper that was never installed alongside it — this file has always been
// broken upstream, and Next only got away with it because nothing imported it.
// The primitives module exports the same four names.
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
